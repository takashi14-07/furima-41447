class OrderAddress
  ...
  attr_accessor :user_id, :token, :item_id, :postal_code, :token, :shipping_from_id, :city, :address_line1, :address_line2,
                :phone_number

  with_options presence: true do
    validates :user_id, :item_id, :postal_code, :shipping_from_id, :city, :address_line1
